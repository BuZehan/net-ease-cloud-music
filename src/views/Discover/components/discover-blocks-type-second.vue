<template >
    <div>
        ...
        <div id="HOMEPAGE_SLIDE_PLAYLIST">
            <div class="scroll-item" v-for="(item, i) in data.creatives"
                :key="i">
                ...
                <div class="scroll-item-right" v-if="res">
                    ...
                    <p v-if="res.resourceExtInfo && res.uiElement.subTitle" class="mrcm">
                        ...
                        <span v-for="artist,i in res.resourceExtInfo.artists" :key="i">{{ artist.name }} &nbsp;&nbsp;</span>
                    </p>
                </div>
                <i></i>
                </p>
